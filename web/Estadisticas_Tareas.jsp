<%@page import="algoritmos.PorcentajeSubTareas"%>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <p class="category">En relación con las tareas</p>
                                    </div>
                                            ...
                                            <div id="skill">    
                                                ...
                                                <%  
                                                    for (int i = 0; i < eventos.size(); i++) {
                                                        ...
                                                        double porcentaje=PorcentajeSubTareas.porcentaje(eventos.get(i).getIdEvento());
