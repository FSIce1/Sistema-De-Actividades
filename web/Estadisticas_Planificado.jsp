...
<html lang="en">
    <head>
        ...
        <title>Estadísticas Planificadas</title>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <p class="category">En relación con el tiempo actual</p>
                                    </div>
                                            ...
                                            if(eventos.size()==0){
                                                ...
                                                <div id="skill">
                                                    <%
                                                        ...
                                                        double porcentaje=PorcentajeFechas.hallarPorcentaje(eventos.get(i).getDiaFinal(), eventos.get(i).getDiaInicio());
