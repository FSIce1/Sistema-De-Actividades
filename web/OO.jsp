<%@ page language="java" contentType="application/pdf; charset=ISO-8859-1"
    ...
    <%
//CODIGO JSP 
FileInputStream ficheroInput = new FileInputStream( "C:\\Users\\User\\Downloads\\Modelos de Tesis\\Tesis\\5\\PROPUESTA PARA IMPLEMENTAR UN SISTEMA DE GESTIÓN DE LA CALIDAD EN LA EMPRESA.pdf" );
